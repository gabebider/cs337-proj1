...
def presenters_for_award_alias(aliases):
...
def presenters_for_award(award):
    award_name = standardize(award_name)
    award_name_aliases = get_aliases(award_name)
    return presenters_for_award_alias(award_name_aliases)
